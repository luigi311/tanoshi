...
## [0.39.3]
- [tanoshi-cli] Fix issues related to generating plugins for extensions

## [0.39.2]
- [tanoshi-extensions] Increase extension concurrent call limit to handle loading large pages in extension catalog browser

## [0.39.1]
- [tanoshi-web] Better completion status on continous reader such as webtoons

## [0.39.0]
- [tanoshi-web] Add manga migration feature
- [tanoshi] Parallelize updates by source
- [tanoshi] Should be more reliable 
- [all] update deps

## [0.38.5]
- [tanoshi-web] Fix more cover breakage

## [0.38.4]
- [tanoshi] Fix covers breaking over time when a manga would refresh the metadata outside the catalogue
...
## [0.38.1]
- [all] Fix not being able to read from downloaded chapters
- [tanoshi] Prevent excess auto downloads when chapters are already downloaded or the manga is not in anyones library
