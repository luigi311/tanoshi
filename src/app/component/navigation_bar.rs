    ...
    fn view(&self) -> Html {
        html! {
           ...
           <div id="tabs" class="flex justify-between">
                <RouterAnchor<AppRoute> route=AppRoute::Home classes="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"  class="inline-block mb-1">
               ...
               <RouterAnchor<AppRoute> route=AppRoute::Source("mangasee".to_string()) classes="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"  class="inline-block mb-1">
