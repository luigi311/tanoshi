    ...
    fn view(&self) -> Html {
        html! {
           ...
           <div id="tabs" class="flex justify-between">
               ...
               <RouterAnchor<AppRoute> route=AppRoute::Browse(BrowseRoute::Catalogue(CatalogueRoute::Select)) classes="w-full text-black dark:text-gray-300 focus:text-tachiyomi-blue hover:text-tachiyomi-blue justify-center inline-block text-center pt-2 pb-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"  class="fill-current inline-block mb-1">
               ...
               <RouterAnchor<AppRoute> route=AppRoute::Browse(BrowseRoute::Updates) classes="w-full text-black dark:text-gray-300 focus:text-tachiyomi-blue hover:text-tachiyomi-blue justify-center inline-block text-center pt-2 pb-1">
                   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"  class="fill-current inline-block mb-1">
               ...
               <RouterAnchor<AppRoute> route=AppRoute::Browse(BrowseRoute::History) classes="w-full text-black dark:text-gray-300 focus:text-tachiyomi-blue hover:text-tachiyomi-blue justify-center inline-block text-center pt-2 pb-1">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"  class="fill-current inline-block mb-1">
