                                    ...
                                    <div class="table-cell p-2 border-b text-center">
                                    {
                                        if !self.users[i].is_edit {
                                            ...
                                            html!{
                                                ...
                                                <select onchange=self.link.callback(move |e: ChangeData| Msg::RoleChange(i, e)) class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
